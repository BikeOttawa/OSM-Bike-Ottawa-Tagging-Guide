...
|<a name='feature-Cycleway-crosses-highway'>Cycleway crosses highway</a> | Places where there are both pedestrian and cycling infrastructure to cross a road.<br> | ![way](img/way.png) [highway](https://wiki.openstreetmap.org/wiki/Key:highway)=footway<br>footway=crossing<br>[bicycle](https://wiki.openstreetmap.org/wiki/Key:bicycle)=yes<br>[segregated](https://wiki.openstreetmap.org/wiki/Key:segregated)=yes | <a href='https://www.mapillary.com/app/?focus=photo&pKey=lDGaiSziBCBSXBk9Dy5ZYA&focus=photo'><img style='min-width:300px;max-width:300px' src='https://d1cuyjsrcm0gby.cloudfront.net/lDGaiSziBCBSXBk9Dy5ZYA&focus=photo/thumb-1024.jpg'></a>|
